...
class FireDetectionApp(ctk.CTk):
    ...
    def _setup_ui(self):
        ...
        # Right panel
        self.right_frame = ctk.CTkFrame(self, corner_radius=16, fg_color="#2E2E2E", border_width=4, border_color="#000")
    ...
    def _prepare_gradients(self):
        # Blue for NO FIRE
        self._no_fire_colors = [
            lerp_color((50, 130, 200), (160, 230, 255), i / (self._arc_segment_count - 1))
            for i in range(self._arc_segment_count)
        ]

        # Red/orange for FIRE
        self._fire_colors = [
            lerp_color((160, 30, 30), (255, 120, 50), i / (self._arc_segment_count - 1))
            for i in range(self._arc_segment_count)
        ]
    ...
    def _animate_confidence(self, target, duration_ms=1000):
        ...
        def step(frame):
            ...
            for i, seg_id in enumerate(self._arc_segments):
                ...
                extent = -coverage * seg_angle - 0.5  # slight overdraw to remove gaps
